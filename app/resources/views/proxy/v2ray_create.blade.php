                    ...
                    <div class="layui-form" lay-filter="">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="country" id="country" lay-verify="required" class="layui-input" value="">
                            </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="vnext_address" id="vnext_address" lay-verify="required"  class="layui-input" value="">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">IP</label>
                            <div class="layui-input-inline">
                                <input type="text" name="vnext_ip" id="vnext_ip" lay-verify="required"  class="layui-input" value="">
                            </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="vnext_port" id="vnext_port" lay-verify="required"  class="layui-input" value="">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">ID</label>
                            <div class="layui-input-inline">
                                <input type="text" name="user_id" id="user_id" lay-verify="required"  class="layui-input" value="">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">alterId</label>
                            <div class="layui-input-inline">
                                <input type="text" name="user_aid" id="user_aid" lay-verify="required"  class="layui-input" value="">
                            </div>
                        </div>
                        <div class="layui-form-item">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="ws_path" id="ws_path" lay-verify="required"  class="layui-input" value="">
                            </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="ws_header_host" id="ws_header_host" lay-verify="required"  class="layui-input" value="">
                            </div>
                        </div>
