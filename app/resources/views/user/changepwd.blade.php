...
<body>
          ...
          <div class="layui-card-body" pad15>
            ...
            <div class="layui-form" lay-filter="">
              ...
              <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                  <input type="password" name="repassword" id="LAY_repassword" lay-verify="repass" lay-verType="tips" autocomplete="off" class="layui-input">
                </div>
              </div>
              <div class="layui-form-item">
  ...
  layui.config({
    ...
    form.on('submit(setmypass)', function(obj){
      ...
      var renewPwd = $('#LAY_repassword').val();
      $.ajax({
        type: "GET",
        url: "/user/changepwd?act=change",
